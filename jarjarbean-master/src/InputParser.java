...
public class InputParser {
    ...
    // Donner les objets qu'on manipule et les entier (cf plus bas) seront leur données membres
    // Utiliser pour composer notre pizza , un design pattern builder
    // Exemple sur les pizza à simplifier : https://fr.wikipedia.org/wiki/Monteur_(patron_de_conception)
    // => Composition de la pizza en part des cellules (qui est une sous matrice de la pizza)
    // => Chaque cellule est soit champignon, soit tomate.
...
//        }
    ...
    private void readInput() {
        ...
        try {
            ...
            // Créer ses objet et instancier le bon type d'objet en fonction des lignes
